            ...
            <div class="col-lg-12">
                <form action="{{ url('produk/create', @$produk->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            <select name="kategori_produk" id="kategori_produk" class="form-control">
                                ...
                                <option @selected(old('kategori_produk') == 'Celana') value="Celana">Celana</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            <input value="{{ old('stok', @$produk->nama_produk) }}" type="number" class="form-control" name="stok" id="stok" placeholder="Stok">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            <input value="{{ old('harga_produk', @$produk->nama_produk) }}" type="number" class="form-control" name="harga_produk" id="harga_produk" placeholder="Harga Produk">
                        </div>
                    </div>
